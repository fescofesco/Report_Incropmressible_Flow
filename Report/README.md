...
```
../Heun/Plots_python/geometry_diagram.png
```

The common geometry figures are in `../Heun/Plots_python/`. Simulation results
used by the report are generated by the AB2 implementation in
`../AdamsBashfort2/Plots_matlab/`.
