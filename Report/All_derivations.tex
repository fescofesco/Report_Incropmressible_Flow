...
equation, plus an empirical check against the CFD solution itself, support the halved
coefficients used here; see \texttt{Report/temperature\_formula\_review.md} for the full
derivation and \texttt{TODO.md} for a reminder to cross-check this against the
lecture-note derivation.
